...
?>
	...
	<section class="layout hero newsletter<?php echo $display_news; ?>">

	    <?php $newsletter = get_field('newsletter', 'option'); ?>

	    <div class="background" style="background-image: url('<?php echo $newsletter['image']['url']; ?>')"></div>

	    <div class="wrapper">

	        <div class="content">

	            <h1><?php echo $newsletter['heading']; ?></h1>

	            <p class="text"><?php echo $newsletter['copy']; ?></p>
...
<section class="layout footer<?php echo $display_footer; ?>">
        ...
        <div class="content">
            ...
            <div class="col">
                ...
                <div class="copyright">
                    ...
                    <?php $footer_copyright = get_field('footer', 'option'); ?>

                    <?php echo $footer_copyright['content']; ?><br>

                    <?php if ($footer_fields['legal']) : ?>

                        <ul class="legal-links">

                            <?php foreach ($footer_fields['legal'] as $legal_field) : ?>

                            	<li class="legal-link"><a href="<?php echo $legal_field['link']['url']; ?>" target="_blank" alt="<?php echo $legal_field['link']['title']; ?>"><?php echo $legal_field['link']['title']; ?></a></li>
